...
@Service
public class PullWeChatQrCodeTaskWebsocketHandler{
	private  final Logger log = LoggerFactory.getLogger(getClass());
	/**
	 * 主动要求手机上传当前登录的微信二维码---pc端经过服务端转发给手机端
	 * @param ctx
	 * @param vo
	 */
    public  void handleMsg(ChannelHandlerContext ctx,TransportMessage vo, String contentJsonStr) {
        try {
        	...
        	if(null != cx){
        		MessageUtil.sendMsg(cx, EnumMsgType.PullWeChatQrCodeTask, NettyConnectionUtil.getNettyId(ctx), null, req);
        		// 告诉发送方消息已收到
