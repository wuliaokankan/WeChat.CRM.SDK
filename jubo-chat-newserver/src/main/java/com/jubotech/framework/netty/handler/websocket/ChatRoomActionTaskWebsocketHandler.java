...
import Jubo.JuLiao.IM.Wx.Proto.ChatRoomActionTask.ChatRoomActionTaskMessage;
...
@Service
public class ChatRoomActionTaskWebsocketHandler{
    ...
    public  void handleMsg(ChannelHandlerContext ctx, TransportMessage vo, String contentJsonStr) {
        try {
        	...
        	if(null != cx){
        		MessageUtil.sendMsg(cx, EnumMsgType.ChatRoomActionTask, NettyConnectionUtil.getNettyId(ctx), null, req);
        		//告诉对方消息已收到
