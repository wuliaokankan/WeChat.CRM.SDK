...
@Service
public class CircleLikeTaskWebsocketHandler{
	private  final Logger log = LoggerFactory.getLogger(getClass());
	/**
	 * 单条朋友圈点赞任务---pc端经过服务端转发给手机端
	 * @param ctx
	 * @param vo
	 */
    public  void handleMsg(ChannelHandlerContext ctx, TransportMessage vo, String contentJsonStr) {
        try {
        	...
        	if(null != cx){
        		MessageUtil.sendMsg(cx, EnumMsgType.CircleLikeTask, NettyConnectionUtil.getNettyId(ctx), null, req);
        		//告诉对方消息已收到
